...
Future<void> main() async {
  print('================================================================');
  print('Syncing All Master Products (Fruits & Vegetables) to [mWallet]');
  print('================================================================\n');
  ...
  final allMasterProducts = [
    ...
    // Vegetables
    {'id': 'veg_1', 'productName': 'Potato', 'localName': 'आलू (Aloo)', 'category': 'Vegetable', 'unit': 'Kg', 'quantity': 1, 'currentPrice': 30},
    {'id': 'veg_2', 'productName': 'Tomato', 'localName': 'टमाटर (Tamatar)', 'category': 'Vegetable', 'unit': 'Kg', 'quantity': 1, 'currentPrice': 40},
    {'id': 'veg_3', 'productName': 'Onion', 'localName': 'प्याज (Pyaz)', 'category': 'Vegetable', 'unit': 'Kg', 'quantity': 1, 'currentPrice': 35},
    {'id': 'veg_4', 'productName': 'Garlic', 'localName': 'लहसुन (Lahsun)', 'category': 'Vegetable', 'unit': 'Gram', 'quantity': 250, 'currentPrice': 50},
    {'id': 'veg_5', 'productName': 'Ginger', 'localName': 'अदरक (Adrak)', 'category': 'Vegetable', 'unit': 'Gram', 'quantity': 250, 'currentPrice': 30},
    {'id': 'veg_6', 'productName': 'Spinach', 'localName': 'पालक (Palak)', 'category': 'Vegetable', 'unit': 'Pack', 'quantity': 1, 'currentPrice': 25},
    {'id': 'veg_7', 'productName': 'Cauliflower', 'localName': 'फूलगोभी (Phool Gobi)', 'category': 'Vegetable', 'unit': 'Pcs', 'quantity': 1, 'currentPrice': 30},
    {'id': 'veg_8', 'productName': 'Cabbage', 'localName': 'पत्तागोभी (Patta Gobi)', 'category': 'Vegetable', 'unit': 'Pcs', 'quantity': 1, 'currentPrice': 25},
    {'id': 'veg_9', 'productName': 'Brinjal / Eggplant', 'localName': 'बैंगन (Baingan)', 'category': 'Vegetable', 'unit': 'Kg', 'quantity': 1, 'currentPrice': 40},
    {'id': 'veg_10', 'productName': 'Lady Finger / Okra', 'localName': 'भिंडी (Bhindi)', 'category': 'Vegetable', 'unit': 'Kg', 'quantity': 1, 'currentPrice': 45},
    {'id': 'veg_11', 'productName': 'Green Peas', 'localName': 'हरी मटर (Hari Matar)', 'category': 'Vegetable', 'unit': 'Kg', 'quantity': 1, 'currentPrice': 60},
    {'id': 'veg_12', 'productName': 'Cucumber', 'localName': 'खीरा (Kheera)', 'category': 'Vegetable', 'unit': 'Kg', 'quantity': 1, 'currentPrice': 30},
    {'id': 'veg_13', 'productName': 'Carrot', 'localName': 'गाजर (Gajar)', 'category': 'Vegetable', 'unit': 'Kg', 'quantity': 1, 'currentPrice': 40},
    {'id': 'veg_14', 'productName': 'Radish', 'localName': 'मूली (Mooli)', 'category': 'Vegetable', 'unit': 'Kg', 'quantity': 1, 'currentPrice': 25},
    {'id': 'veg_15', 'productName': 'Bottle Gourd', 'localName': 'लौकी (Lauki)', 'category': 'Vegetable', 'unit': 'Pcs', 'quantity': 1, 'currentPrice': 30},
    {'id': 'veg_16', 'productName': 'Bitter Gourd', 'localName': 'करेला (Karela)', 'category': 'Vegetable', 'unit': 'Kg', 'quantity': 1, 'currentPrice': 50},
    {'id': 'veg_17', 'productName': 'Ridge Gourd', 'localName': 'तरोई (Taroi)', 'category': 'Vegetable', 'unit': 'Kg', 'quantity': 1, 'currentPrice': 40},
    {'id': 'veg_18', 'productName': 'Capsicum', 'localName': 'शिमला मिर्च (Shimla Mirch)', 'category': 'Vegetable', 'unit': 'Kg', 'quantity': 1, 'currentPrice': 60},
    {'id': 'veg_19', 'productName': 'Green Chilli', 'localName': 'हरी मिर्च (Hari Mirch)', 'category': 'Vegetable', 'unit': 'Gram', 'quantity': 250, 'currentPrice': 20},
    {'id': 'veg_20', 'productName': 'Lemon', 'localName': 'नींबू (Nimbu)', 'category': 'Vegetable', 'unit': 'Pcs', 'quantity': 4, 'currentPrice': 20},
  ];
  ...
  for (final user in users) {
    ...
    for (final p in allMasterProducts) {
      final insertSql = '''
      ...
      final params = [
        ...
        (p['currentPrice'] as num).toDouble(),
        0.0,
        1,
        0,
        now,
      ...
      try {
        ...
        print('  [!] Error inserting ${p['productName']} for user $userId: $e');
      }
    }
  }

  print('\n================================================================');
  print('Successfully synced $totalInserted Master Products across all users in [mWallet]!');
  print('================================================================');
}
